...
Android 2.2 is the minimum android version on which _BlinkOCR_ is supported, but if required we may support even Android 2.1 devices, however additional testing on those devices will be required.
